...
var vm = new Vue({
  ...
  methods: {
    ...
    initDatas() {
      ...
      this.$axios.get('http://39.105.19.68:8000/commentarea/get_comment_area?commentAreaId=' + this.commentAreaId)
        .then(
          (res) => {
            res = res.data
            if (res.code != 200) {
            ...
            this.$axios.get('http://39.105.19.68:8000/commentarea/get_paper?paperId=' + res.comment_area.paper)
              .then(
                (response) => {
            ...
            res.comment_area.short_comment_list.forEach((shortCommentId) => {
              this.$axios.get('http://39.105.19.68:8000/commentarea/get_short_comment?shortCommentId=' + shortCommentId)
                .then(
                  (response) => {
                    if (response.code != 200) {
                      console.log('failed to initialize')
            ...
            res.comment_area.long_comment_list.forEach((longCommentId) => {
              this.$axios.get('http://39.105.19.68:8000/commentarea/get_long_comment?inCommentArea=true&longCommentId=' + longCommentId)
                .then(
                  (response) => {
                    if (response.code != 200) {
                      console.log('failed to initialize')
    ...
    handleRose(count) {
      if (!this.shortCommentList[count - 1].has_egg) {
        if (!this.shortCommentList[count - 1].has_rose) {
          this.$axios.get('http://39.105.19.68:8000/commentarea/rose_comment?shortCommentId=' + this.shortCommentList[count - 1].id)
            .then(
              (res) => {
                if (res.code === 200) {
          ...
          this.$axios.get('http://39.105.19.68:8000/commentarea/cancel_rose_comment?shortCommentId=' + this.shortCommentList[count - 1].id)
            .then(
              (res) => {
                if (res.code === 200) {
    ...
    handleEgg(count) {
      if (!this.shortCommentList[count - 1].has_rose) {
        if (!this.shortCommentList[count - 1].has_egg) {
          this.$axios.get('http://39.105.19.68:8000/commentarea/egg_comment?shortCommentId=' + this.shortCommentList[count - 1].id)
            .then(
              (res) => {
                if (res.code === 200) {
          ...
          this.$axios.get('http://39.105.19.68:8000/commentarea/cancel_egg_comment?shortCommentId=' + this.shortCommentList[count - 1].id)
            .then(
              (res) => {
                if (res.code === 200) {
    ...
    handleStar(count) {
      if (!this.longCommentList[count - 1].has_star) {
        this.$axios.get('http://39.105.19.68:8000/commentarea/star_comment?longCommentId=' + this.longCommentList[count - 1].id)
          .then(
            (res) => {
              if (res.code === 200) {
        ...
        this.$axios.get('http://39.105.19.68:8000/commentarea/cancel_star_comment?longCommentId=' + this.longCommentList[count - 1].id)
          .then(
            (res) => {
              if (res.code === 200) {
    ...
    handlePostShortComment() {
      if (this.shortCommentInput.length > 0) {
        ...
        this.$axios.post('http://39.105.19.68:8000/commentarea/post_short_comment', JSON.stringify(data), config)
          .then(
            (res) => {
              if (res.code === 200) {
    ...
    handlePostLongComment() {
      if (this.longCommentInput.title.length > 0 && this.longCommentInput.content.length > 0) {
        ...
        this.$axios.post('http://39.105.19.68:8000/commentarea/post_long_comment', JSON.stringify(data), config)
          .then(
            (res) => {
              if (res.code === 200) {
    ...
    handleStarArea() {
      if (!this.area_has_star) {
        this.$axios.get('http://39.105.19.68:8000/commentarea/star_comment_area?commentAreaId=' + this.commentAreaId)
          .then(
            (res) => {
              if (res.code === 200) {
