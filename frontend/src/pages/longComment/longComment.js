  ...
  methods: {
    ...
    initDatas() {
      this.longComment.id = parseInt(this.getParams("id"))
        //! 需要修改，等待API
      this.$axios.get('http://39.105.19.68:8000/commentarea/get_long_comment?inCommentArea=false&longCommentId=' + this.longComment.id)
        .then(
          (res) => {
            res = res.data
            if (res.code != 200) {
    ...
    handleStar() {
      if (!this.longComment.has_star) {
        this.$axios.get('http://39.105.19.68:8000/commentarea/star_comment?longCommentId=' + this.longComment.id)
          .then(
            (res) => {
              res = res.data
              if (res.code === 200) {
        ...
        this.$axios.get('http://39.105.19.68:8000/commentarea/cancel_star_comment?longCommentId=' + this.longComment.id)
          .then(
            (res) => {
              res = res.data
              if (res.code === 200) {
    ...
    handlePostShortComment() {
      if (this.shortCommentInput.length > 0) {
        ...
        this.$axios.post('http://39.105.19.68:8000/commentarea/post_short_comment_for_long_comment', JSON.stringify(data), config)
          .then(
            (res) => {
              res = res.data
              if (res.code === 200) {
